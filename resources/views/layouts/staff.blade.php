                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a href="/staff/slides"><i class="fa fa-sliders"></i> Slides</a>
                            </li>                           
                            <li><a href="/staff/posts"><i class="fa fa-newspaper-o"></i> Posts</a>
                            </li>
                            <li><a href="/staff/menus"><i class="fa fa-list-alt"></i> Menus</a>
                            </li>
                            </li>
                            <li><a href="/staff/files"><i class="fa fa-picture-o"></i> Media Library</a>
                            </li>
                            </li>
                            <li><a href="/staff/userRequests"><i class="fa fa-comment"></i> User Requests</a>
                            </li>    
                        </ul>
                    </div>
