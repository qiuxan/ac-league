                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        <ul class="nav side-menu">
                            <li><a href="/member"><i class="fa fa-home"></i> Home</a>
                            </li>
                            <li><a href="/member/products"><i class="fa fa-product-hunt"></i> Products</a>
                            </li>
                            <li><a href="/member/production-partners"><i class="fa fa-briefcase"></i> Production Partners</a>
                            </li>                            
                            <li><a href="/member/batches"><i class="fa fa-list-ol"></i> Batches</a>
                            </li>
                            <li><a href="/member/rolls"><i class="fa fa-circle-o"></i> Rolls</a>
                            </li>
                            <li><a href="/member/codes"><i class="fa fa-barcode"></i> Serials</a>
                            </li>
                            <li><a href="/member/reports"><i class="fa fa-history"></i> Reports</a>
                            </li>
                            <li><a href="/member/survey"><i class="fa fa-exchange"></i> Survey</a>
                            </li>
                            <li><a href="/member/files"><i class="fa fa-picture-o"></i> Media Library</a>
                            </li>          
                            <li><a href="/member/messages"><i class="fa fa-envelope-o"></i> Messages</a>
                            </li>                                   
                            <li><a href="/member/cartons"><i class="fa fa-cube"></i> Cartons</a>
                            </li>                                                                                    
                            <li><a href="/member/pallets"><i class="fa fa-cubes"></i> Pallets</a>
                            </li>                                                                                                                
                            <!--
