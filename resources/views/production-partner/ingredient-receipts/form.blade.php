...
@section('content')
    ...
    <div class="x_panel">
        <div class="x_title">
            <h2>Ingredient Receipt Details</h2>
            <div class="clearfix"></div>
        </div>
        <div id="ingredientReceiptFormDiv" class="x_content">
            <div class="formWrap">
                <form id="ingredientReceiptForm" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                    ...
                    <fieldset class="pull-left">
                        <ul>
                            ...
                            <li>
                                ...
                                <input data-bind="value: tracking_code" type="text" readonly id="tracking_code" class="k-textbox" name="tracking_code" placeholder="Tracking Code"/>
                            </li>
                            @role(\App\Constant::CONTRACT_MANUFACTURER)
                            <li>
...
<!-- page scripts -->
<script src="{{ asset('js/apps/production-partner/ingredient-receipts/IngredientReceiptForm.js') }}?v=1.0.0" type="text/javascript"></script>
<!-- /page scripts -->
