        ...
        <div id="productFormDiv" class="x_content">
            <div id="tabs">
                <ul>
                    ...
                    <li data-bind="invisible: isNew">Product Ingredients</li>
                </ul>
                <div class="formWrap">
                ...
                <div>
                    <script type="text/x-kendo-template" id="ingredientToolbarTemplate">
                        <div class="pull-left">
                            <a class="k-button" id="addIngredient">
                                <span class="k-icon k-i-plus">&nbsp;</span>
                                <span>Add</span>
                            </a>
                            <a class="k-button k-state-disabled" id="deleteIngredient">
                                <span class="k-icon k-i-close">&nbsp;</span>
                                <span>Delete</span>
                            </a>
                        </div>
                    ...
                    <div>
                        <div id="productIngredientsGrid"></div>
...
<script src="{{ asset('js/apps/production-partner/products/ProductForm.js') }}?v=1.0.0" type="text/javascript"></script>
<script src="{{ asset('js/apps/production-partner/products/ProductAttributeList.js') }}?v=1.0.0" type="text/javascript"></script>
<!-- /page scripts -->
