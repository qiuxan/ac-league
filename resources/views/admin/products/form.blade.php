            ...
            <div id="tabs">
                ...
                <div class="formWrap">
                    <form id="productForm" enctype="multipart/form-data">
                        ...
                        <!-- end of traditional chinese fields -->                
                        <div class="clearfix"></div>
                        <div class="actionBar">
...
<script src="{{ asset('js/apps/admin/products/ProductForm.js') }}?v=1.0.0" type="text/javascript"></script>
<script src="{{ asset('js/apps/admin/products/ProductAttributeList.js') }}?v=1.0.0" type="text/javascript"></script>
<!-- /page scripts -->
