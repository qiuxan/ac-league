...
@section('content')
    ...
    <div class="x_panel">
        ...
        <div id="memberFormDiv"  class="x_content">
            <div id="tabs">
                <ul>
                    <li class="k-state-active">Member Info</li>
                    <li data-bind="invisible: isNew">Member Permissions</li>
                </ul>
                <div class="formWrap">
                        ...
                        <fieldset class="pull-left">
                            <ul>
                                ...
                                <li>
                                    ...
                                    <input data-bind="value: company_tr" type="text" id="company_tr" name="company_tr" class="k-textbox" required validationMessage="This field is required" placeholder="Traditional Chinese Name"/>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <select name="status" id="status" data-bind="value: status" required validationMessage="This field is required">
                ...
                <div class="formWrap">
                    <form id="memberPermissionForm" enctype="multipart/form-data">
                        {!! csrf_field() !!}
                        <input data-bind="value: user_id" name="user_id" type="hidden"/>
                        <h3>Permissions</h3>
                    ...
                    @endif
                        ...
                        <div class="actionBar">
                            <div class="actionBarLeft">
                                <button class="k-button" type="button" id="cancelPermissionButton">Cancel</button>
                            </div>
                            <div class="actionBarRight">
                                <span class="status"></span>
                                <button class="k-button" type="button" id="savePermissionButton">Save</button>
                                <button class="k-button" type="button" id="donePermissionButton">Done</button>
                            </div>
                        </div>
                    </form>
                </div>
...
<!-- page scripts -->
<script src="{{ asset('js/apps/admin/members/MemberForm.js') }}?v=1.0.0" type="text/javascript"></script>
<!-- /page scripts -->
