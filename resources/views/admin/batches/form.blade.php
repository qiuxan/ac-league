                        ...
                        <fieldset class="pull-left">
                            <ul>
                                <li>
                                    ...
                                    <input data-bind="value: member_id" id="member_id" name="member_id" required validationMessage="This field is required" />
                                    <!-- Template -->
                                    <script id="member_template" type="text/x-kendo-template">
                                        #:data.company_en#
                                    </script>
                                    <span class="k-invalid-msg" data-for="company_en"></span>
                                </li>
                                <li>
