        ...
        <div id="rollFormDiv" class="x_content">
            <div class="formWrap">
                <form id="rollForm" enctype="multipart/form-data">
                    ...
                    <input data-bind="value: member_id" id="member_id" name="member_id" type="hidden" />
                    <fieldset class="pull-left">
                        <ul>
                            <li>
                                <label for="production_partner_id">Production Partner</label>
                                <input data-bind="value: production_partner_id" id="production_partner_id" name="production_partner_id" />
                                <!-- Template -->
...
<!-- page scripts -->
<script src="{{ asset('js/apps/member/rolls/RollForm.js') }}?v=1.0.0" type="text/javascript"></script>
