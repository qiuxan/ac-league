    ...
    return new kendo.data.DataSource(
        {
            ...
            transport:
            {
                read:
                {
                    url: "/production-partner/getProducts",
                    dataType: 'json',
                    data:
                    {
...
ProductList.editProduct = function()
{
    ...
    if( uid )
    {
        ...
        $( '#mainContentDiv' ).load( "/production-partner/getProductForm" );
    }
}
...
ProductList.deleteProducts = function()
{
    ...
    Utils.confirm().yesCallBack(function () {
        $.post("/production-partner/deleteProducts", {ids: ids, _token: $('[name="_token"]').val()}, function () {
