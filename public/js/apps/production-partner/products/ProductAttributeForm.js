    ...
    var viewModel = kendo.observable(
        {
            ...
            load: function( onComplete )
            {
                ...
                {
                    $.get( '/production-partner/getProductAttribute', { id : _product_attribute_id }, function( product_attribute )
                    {
...
ProductAttributeForm.save = function( returnToList, onComplete )
{
    ...
    $.post( "/production-partner/saveProductAttribute", $( "#productAttributeForm" ).serialize(), function( response )
    {
