    ...
    return new kendo.data.DataSource(
        {
            ...
            transport:
            {
                read:
                {
                    url: "/production-partner/getProductAttributes",
                    dataType: 'json',
                    data:
                    {
...
ProductAttributeList.deleteProductAttributes = function()
{
    ...
    Utils.confirm().yesCallBack(function () {
        $.post("/production-partner/deleteProductAttributes", {ids: ids, _token: $('[name="_token"]').val()}, function () {
...
ProductAttributeList.showProductAttributeForm = function(){
    ...
    $("#productAttributeFormContainer").load( "/production-partner/getProductAttributeForm");
}
