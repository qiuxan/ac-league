    ...
    return new kendo.data.DataSource(
        {
            ...
            transport:
            {
                read:
                {
                    url: "/production-partner/getBatches",
                    dataType: 'json',
                    data:
                    {
...
BatchList.editBatch = function()
{
    ...
    if( uid )
    {
        ...
        $( '#mainContentDiv' ).load( "/production-partner/getBatchForm" );
    }
}
...
BatchList.deleteBatches = function()
{
    ...
    Utils.confirm().yesCallBack(function () {
        $.post("/production-partner/deleteBatches", {ids: ids, _token: $('[name="_token"]').val()}, function () {
