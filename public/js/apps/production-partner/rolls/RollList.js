    ...
    return new kendo.data.DataSource(
        {
            ...
            transport:
            {
                read:
                {
                    url: "/production-partner/getRolls",
                    dataType: 'json',
                    data:
                    {
...
RollList.editRoll = function()
{
    ...
    if( uid )
    {
        ...
        $( '#mainContentDiv' ).load( "/production-partner/getRollForm" );
    }
}
...
RollList.deleteRolls = function()
{
    ...
    Utils.confirm().yesCallBack(function () {
        $.post("/production-partner/deleteRolls", {ids: ids, _token: $('[name="_token"]').val()}, function () {
            RollList.filterGrid();
        });
