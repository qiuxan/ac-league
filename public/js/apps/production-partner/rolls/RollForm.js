    ...
    var viewModel = kendo.observable(
        {
            ...
            load: function( onComplete )
            {
                ...
                if( _roll_id )
                {
                    $.get( '/production-partner/getRoll', { id : _roll_id }, function( roll )
                    {
                        for( var key in roll )
                        {
...
{
    _roll_id = 0;
    $( '#mainContentDiv' ).load( "/production-partner/getRollList" );
}
...
RollForm.save = function( returnToList, onComplete )
{
    ...
    $.post( "/production-partner/saveRoll", $( "#rollForm" ).serialize(), function( response )
    {
    ...
    return new kendo.data.DataSource(
        {
            ...
            transport:
            {
                read:
                {
                    url: "/production-partner/getRollCodes",
                    dataType: 'json',
                    data:
                    {
...
RollForm.showCodeForm = function(){
    ...
    $("#codeFormContainer").load( "/production-partner/getCodeForm");
}
