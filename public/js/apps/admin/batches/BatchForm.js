...
BatchForm.loadResellerList = function() {
...
BatchForm.addBatchRoll = function()
{
    ...
    {
        Utils.alert().show("Please save Batch first, then add roll for batch!");
    }
}
...
BatchForm.deleteBatchRolls = function()
{
    ...
    Utils.confirm().yesCallBack(function () {
        $.post("/admin/deleteBatchRolls", {ids: ids, _token: $('[name="_token"]').val()}, function () {
...
BatchForm.showBatchRollForm = function(){
    ...
    $("#batchRollFormContainer").load( "/admin/getBatchRollForm");
}
