    ...
    return new kendo.data.DataSource(
        {
            ...
            transport:
            {
                read:
                {
                    url: "/admin/getProductionPartners",
                    dataType: 'json',
                    data:
                    {
...
ProductionPartnerList.addProductionPartner = function(){
    ...
    $( '#mainContentDiv' ).load( "/admin/getProductionPartnerForm" );    
}
...
ProductionPartnerList.deleteProductionPartners = function(){
    ...
    Utils.confirm().yesCallBack(function () {
        $.post("/admin/deleteProductionPartners", {ids: ids, _token: $('[name="_token"]').val()}, function (response) {
