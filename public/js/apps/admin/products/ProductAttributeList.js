    ...
    return new kendo.data.DataSource(
        {
            ...
            transport:
            {
                read:
                {
                    url: "/admin/getProductAttributes",
                    dataType: 'json',
                    data:
                    {
                        product_id: _product_id
...
ProductAttributeList.deleteProductAttributes = function()
{
    ...
    Utils.confirm().yesCallBack(function () {
        $.post("/admin/deleteProductAttributes", {ids: ids, _token: $('[name="_token"]').val()}, function () {
...
ProductAttributeList.showProductAttributeForm = function(){
    ...
    $("#productAttributeFormContainer").load( "/admin/getProductAttributeForm");
}
