    ...
    var viewModel = kendo.observable(
        {
            ...
            load: function( onComplete )
            {
                ...
                {
                    $.get( '/admin/getProductAttribute', { id : _product_attribute_id }, function( product_attribute )
                    {
...
ProductAttributeForm.save = function( returnToList, onComplete )
{
    ...
    $.post( "/admin/saveProductAttribute", $( "#productAttributeForm" ).serialize(), function( response )
    {
