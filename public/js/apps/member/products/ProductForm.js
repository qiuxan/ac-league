    ...
    var viewModel = kendo.observable(
        {
            ...
            load: function( onComplete )
            {
                ...
                if( _product_id )
                {
                    $.get( '/member/getProduct', { id : _product_id }, function( product )
                    {
...
{
    _product_id = 0;
    $( '#mainContentDiv' ).load( "/member/getProductList" );
}
...
ProductForm.save = function( returnToList, onComplete )
{
    ...
    $.post( "/member/saveProduct", $( "#productForm" ).serialize(), function( response )
    {
...
{
    $.post( '/member/addProductImage', { product_id: _product_id, file_id: e.response.result.id, _token: $('[name="_token"]').val() }, function()
    {
        ProductForm.setImages();
    });
}
...
ProductForm.deleteProductImage = function( file_id )
{
    Utils.confirm().yesCallBack( function(){
        $.post( '/member/deleteProductImage', { product_id: _product_id, file_id: file_id, _token: $('[name="_token"]').val() }, function()
        {
            ProductForm.setImages();
        })
...
ProductForm.setProductImageDescription = function( file_id, lang )
{
    ...
    if (lang == 1)
        ...
        $.post( '/member/setProductImageDescription', { product_id: _product_id, file_id: file_id, description: description, lang: lang,  _token: $('[name="_token"]').val() });
}

ProductForm.setProductImagePriority = function( file_id_list )
{
    $.post( '/member/setProductImagePriority', { product_id: _product_id, file_id_list: file_id_list, _token: $('[name="_token"]').val() });
}

ProductForm.setProductThumbnail = function( file_id )
{
    $.post( '/member/setProductThumbnail', { product_id: _product_id, file_id: file_id, _token: $('[name="_token"]').val() }, function () {
        ProductForm.setImages();
    });
}
